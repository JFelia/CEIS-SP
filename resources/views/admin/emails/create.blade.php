          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="existing">    
                  ...
                  <form role="form" action="{{route('emails.store')}}" method="post">
                  {{csrf_field()}}
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <select class="form-control select2" multiple="multiple" data-placeholder="Recipient:"
                            ...
                            <option>{{$contact->client_code}} - {{$contact->name}} - {{$contact->contact_no}}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="form-group">
              ...
              <div class="tab-pane" id="anonymous">
                  <form role="form" action="{{url('/emails/anonymous')}}" method="post">
                  {{csrf_field()}}
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <table width="100%">
                            ...
                            <td>
                              <input type="number" name="recipients" class="form-control" placeholder="Recipients">
                            </td>
                          </table>
                      </div>
                      <div class="form-group">
          ...
          <div class="box box-primary">
              ...
              <div class="box-body">
                <div class="box-body box-profile">
                    <p>Type <b>Recipient Number</b></p>
                    <p>Allow <b>Multiple Recipient</b> separated with <b>Whitespace</b></p>
                    <p>Type your message <b>Message</b> and</p>
                    <p>Click <b>Send</b></p>
                    <hr>
                    <p>You can <b>Discard</b> your message</p>
                </div>
              </div>
            </div>
            </div>
