...
@section('content')
  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/addstaff">People</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="{{url('/admin/addstaff')}}" method="post">
            {{csrf_field()}}
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group{{$errors->has('birthday')?' has-error' : ''}}">
                    ...
                    <input type="date" class="form-control" placeholder="Enter Birthday" name="birthday" autocomplete="off" value="{{old('birthday')}}">
                  ...
                  <div class="form-group{{$errors->has('cpassword')?' has-error' : ''}}">
                    ...
                    {!! $errors->first('cpassword','<span class="help-block">:message</span>') !!}
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group{{$errors->has('telephone')?' has-error' : ''}}">
                    ...
                    <table width="100%">
                        ...
                        <td>
                          <input type="number" class="form-control" placeholder="Enter Telephone Number" name="telephone" autocomplete="off" value="{{old('telephone')}}">
                        </td>
                      </table>
                  ...
                  <div class="form-group{{$errors->has('state')?' has-error' : ''}}">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Region/State" name="state" autocomplete="off" value="{{old('state')}}">
                  ...
                  <div class="form-group{{$errors->has('country')?' has-error' : ''}}">
                    ...
                    <table width="100%">
                      <td width="100%">
                        <select name="country" id="" class="form-control" value="{{old('country')}}">
                        ...
                        <optgroup label="Other countries">
                          ...
                          <option>Yemen (North)</option>
                          <option>Yemen (South)</option>
                  ...
                  <div class="form-group{{$errors->has('zip')?' has-error' : ''}}">
                    ...
                    <input type="number" class="form-control" placeholder="Enter Zip Code" name="zip" autocomplete="off" value="{{old('zip')}}">
                  ...
                  <div class="form-group{{$errors->has('user_level')?' has-error' : ''}}">
                    ...
                    <select class="form-control" name="user_level" value="{{old('user_level')}}">
                      ...
                      <option value="{{$obj->role_name}}">{{$obj->role_name}}</option>
                      @endforeach
                    </select>
                    {!! $errors->first('user_level','<span class="help-block">:message</span>') !!}
                  </div>
                </div>
              </div>
