...
<head>
  <meta charset="utf-8">
  <link rel="shortcut icon" href="<?php echo e(asset('LTE/dist/img/gm.png')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('LTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('LTE/dist/emoji/emojionearea.css')); ?>">
  
  <link rel="stylesheet" href="<?php echo e(asset('LTE/angular.min.js')); ?>">
      ...
      <br><br><br>
        ...
        <?php if(Session::has('flash_message_error')): ?>
            <div class="alert alert-dismissable alert-danger">
                ...
                <strong><i class="icon fa fa-ban"></i><?php echo session('flash_message_error'); ?></strong>
            </div>
        <?php endif; ?>
        <?php if(Session::has('flash_message_success')): ?>
            <div class="alert alert-dismissable alert-success">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    ...
                    <strong><i class="icon fa fa-check"></i><?php echo session('flash_message_success'); ?></strong>
            </div>
        <?php endif; ?>
    <?php echo $__env->yieldContent('content'); ?>
    </div>
    <?php echo $__env->make('layouts.adminLayout.admin_modals', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('layouts.adminLayout.admin_footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

</div>

<!-- <script src="<?php echo e(asset('LTE/sweetalert.min.js')); ?>"></script> -->
...
<!-- for emoji-picker -->
<!-- <script src="<?php echo e(asset('LTE/bower_components/jquery/dist/jquery.min.js')); ?>"></script> -->
<!-- <script src="<?php echo e(asset('LTE/dist/emoji-picker/lib/js/config.js')); ?>"></script>
<script src="<?php echo e(asset('LTE/dist/emoji-picker/lib/js/util.js')); ?>"></script>
<script src="<?php echo e(asset('LTE/dist/emoji-picker/lib/js/jquery.emojiarea.js')); ?>"></script>
<script src="<?php echo e(asset('LTE/dist/emoji-picker/lib/js/emoji-picker.js')); ?>"></script> -->

<script src="<?php echo e(asset('LTE/dist/emoji/emojionearea.min.js')); ?>" ></script>
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo e(asset('LTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('LTE/bower_components/ckeditor/ckeditor.js')); ?>"></script>
<script src="<?php echo e(asset('LTE/bower_components/select2/dist/js/select2.full.min.js')); ?>"></script>

<?php echo $__env->make('layouts.adminLayout.admin_scripts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
